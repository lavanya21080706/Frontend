...
const Share = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const { title, priority, checklist, cb, dueDate } = response.data;
            const checkedItems = new Set(cb.filter((item) => checklist.includes(item.trim())));
    ...
    const [checkedCheckboxes, setCheckedCheckboxes] = useState(new Set(data.cb));
